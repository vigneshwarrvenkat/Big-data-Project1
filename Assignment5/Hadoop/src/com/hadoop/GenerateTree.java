...
public class GenerateTree {
	...
	*/
	 ...
	 * @throws IOException 
	 */
	public GenerateTree(ArrayList<int[]> data,RandomForest forest,int num) throws IOException, InterruptedException{
		this.forest=forest;
		N=data.size();
	    ...
	    map.map(null,null, null, train, num);
...
//		System.out.print("\n");
	 ...
	 */
	public TreeNode CreateTree(ArrayList<int[]> train, int ntree){
